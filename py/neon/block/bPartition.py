...
class bPartitionInt(ctypes.Structure):
    ...
    def _help_load_api(self):
        self.neon.lib.bGrid_bField_bPartition_get_member_field_offsets.argtypes = [ctypes.POINTER(ctypes.c_size_t), ctypes.POINTER(ctypes.c_size_t)]
        self.neon.lib.bGrid_bField_bPartition_get_member_field_offsets.restype = None

    def get_cpp_field_offsets(self):
        length = ctypes.c_size_t()
        offsets = (ctypes.c_size_t * 9)()  # Since there are 9 offsets
        self.neon.lib.bGrid_bField_bPartition_get_member_field_offsets(offsets, ctypes.byref(length))
